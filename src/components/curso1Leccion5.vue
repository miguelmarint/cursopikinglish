  ...
  <div>
    <div class="row">
      ...
      <div class="col-sm-8" id="cuadroTexto">
        <h3>Recuerde que un verbo se usassss<span class="colorLetraRojo">forma presente lógicamente en presente </span> o después de un auxiliar y siempre tenga en cuenta que los auxiliares sirven para negar o preguntar.</h3>
      </div>
      <div class="col-sm-2"></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-7 row">
        <div class="col-sm-3" v-for="item in tablasContenido1P27">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <tablaTC
          class="overflow-auto"
          :cuestionario="$data.cuestionario1P27"
          :inglesR="false"
          :espanolR="false"
        />
      </div>
    ...
    <div class="row">
      <div class="col-sm-1"></div>
      <div class="col-sm-7 row">
        <div class="col-sm-3" v-for="item in tablasContenido2P27">
          <listaIndex :tabla="item" />
        </div>
      </div>
    </div>
